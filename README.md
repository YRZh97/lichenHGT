...
=========================================================================================================================================================================================================================  
lichenHGT-plot.ipynb contains codes used to generate the figures in the main text and supplementary materials. 'kmerfreq_total_4mer' file could be generated using kmerfreq_exclud.py, 'gene_on_contig0422' file could be generated by stat_hgtcontigs.py, 'breakp_data_update.xlsx' file could be generated using depth.py, 'target_gene_annotation2021.tsv' file is a combination of 'gene_on_contig0422' and Supplementary Datasets 4-6.
